...
public class BibliotoolMenuBar extends JMenuBar {
	...
	public BibliotoolMenuBar(Window2 window){
		 this.window = window;
	...
	private void addItemsToMenu(JMenuBar menuBar){
		...
		//menuFilePrint.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, KeyEvent.CTRL_MASK));
		...
		menuPaste.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, KeyEvent.CTRL_MASK));
