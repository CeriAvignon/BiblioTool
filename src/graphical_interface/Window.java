...
public class Window extends JFrame {
	...
	public void MakeContaintProfile(){
 	   ...
 	   this.getContentPane().add(new JPanel().add(new JLabel("Profile page under construction")));
	...
	public void MakeContaintLogIn(){
		...
		this.getContentPane().add(new JPanel().add(new JLabel("Log in form under construction")));
	...
	public void MakeContaintSign(){
		...
		this.getContentPane().add(new JPanel().add(new JLabel("Sign up form under construction")));
		this.getContentPane().add(new JPanel().add(new JLabel("")));
		this.getContentPane().add(new JPanel().add(new JLabel("")));
		this.getContentPane().add(new JPanel().add(new JLabel("")));
		this.getContentPane().add(new JPanel().add(new JLabel("")));
