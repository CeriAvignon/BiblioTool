...
public final class MyGraph {
	...
	*/
	...
	public static DirectedGraph retournerListe() {
		DirectedGraph directedGraph2 = createDirectedGraph();
		List<Article> article = new ArrayList<Article>();
		List<Article> article1 = new ArrayList<Article>();
		if(((Article) article).getAuthor().equals(((Article) article1).getAuthor())){
			
			Node n1 = graphModel.factory().newNode(String.valueOf(((Article) article).getIdArt()));
		    directedGraph2.addNode(n1);
			Node n2 = graphModel.factory().newNode(String.valueOf(((Article) article1).getIdArt()));
			directedGraph2.addNode(n2);
			Edge e = directedGraph2.getEdge(n1, n2);
			directedGraph2.addEdge(e);
